...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final LayoutTopAppBarBinding topAppBar;
  ...
  private ActivityMainBinding(@NonNull DrawerLayout rootView, @NonNull DrawerLayout drawerLayout,
      ...
      @NonNull LayoutTopAppBarBinding topAppBar) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.topAppBar;
      View topAppBar = ViewBindings.findChildViewById(rootView, id);
      if (topAppBar == null) {
        break missingId;
      }
      LayoutTopAppBarBinding binding_topAppBar = LayoutTopAppBarBinding.bind(topAppBar);

      return new ActivityMainBinding((DrawerLayout) rootView, drawerLayout, fragmentContainer,
          navigationView, binding_topAppBar);
    }
